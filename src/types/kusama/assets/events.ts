...
export const created = {
   ...
   */
  v1: new EventType('Assets.Created', sts.tuple([v1.AssetId, v1.AccountId, v1.AccountId])),
  /**
...
export const destroyed = {
   ...
   */
  v1: new EventType('Assets.Destroyed', v1.AssetId),
  /**
   * An asset class was destroyed.
   */
  v700: new EventType(
...
export const forceCreated = {
   ...
   */
  v1: new EventType('Assets.ForceCreated', sts.tuple([v1.AssetId, v1.AccountId])),
  /**
...
export const metadataCleared = {
   ...
   */
  v1: new EventType('Assets.MetadataCleared', v1.AssetId),
  /**
